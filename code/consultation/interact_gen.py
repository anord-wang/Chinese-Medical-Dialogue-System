...
def set_args():
    ...
    #parser.add_argument('--model_path', default='model/kb_qa_graph/epoch20', type=str, required=False, help='对话模型路径')
    parser.add_argument('--model_path', default='model/kb_qa_graph/min_ppl_model', type=str, required=False, help='对话模型路径')
    #parser.add_argument('--model_path', default='model/cluecorpussmal', type=str, required=False, help='对话模型路径')
    parser.add_argument('--save_samples_path', default="sample/med_qa_test/pretrain_graph/with_supply/min_ppl_model/", type=str, required=False, help="保存聊天记录的文件路径")
