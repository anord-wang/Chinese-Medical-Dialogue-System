...
def set_args():
    ...
    parser.add_argument('--vocab_path', default='vocab/vocab2.txt', type=str, required=False,
                        help='词表路径')
    parser.add_argument('--model_config', default='config/config.json', type=str, required=False,
                        help='设置模型参数')
    parser.add_argument('--train_path', default='data/med_qa_train.pkl', type=str, required=False, help='训练集路径')
    parser.add_argument('--max_len', default=500, type=int, required=False, help='训练时，输入数据的最大长度')

    parser.add_argument('--log_path', default='data/med_kb_qa_train.log', type=str, required=False, help='训练日志存放位置')
    ...
    parser.add_argument('--batch_size', default=5, type=int, required=False, help='训练的batch size')
    ...
    parser.add_argument('--save_model_path', default='model/kb_qa', type=str, required=False,
                        help='模型输出路径')
    parser.add_argument('--pretrained_model', default='model/gpt_pretrain_again', type=str, required=False,
                        help='预训练的模型的路径')
